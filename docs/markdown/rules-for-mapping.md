...
19. <span class="tooltip"><u>Шаттл **НЕ** должен использовать закрытые шлюзы, все шлюзы на шаттлах должны быть **БЕЗ** доступов</u><span class="tooltip-img"><img src="../assets/images/acces-lock.png"></span></span>
